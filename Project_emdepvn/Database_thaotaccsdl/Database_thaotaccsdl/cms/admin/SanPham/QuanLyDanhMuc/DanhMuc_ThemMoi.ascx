<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMuc_ThemMoi.ascx.cs" Inherits="Database_thaotaccsdl.cms.admin.SanPham.QuanLyDanhMuc.DanhMuc_ThemMoi" %>
<div class="head">
