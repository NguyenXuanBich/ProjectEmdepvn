...
namespace Database_thaotaccsdl.cms.admin.SanPham.QuanLyMau.Ajax
{
    public partial class Mau : System.Web.UI.Page
    {
        ...
        private void XoaSanPham(string ma)
        {
            ...
            dt1 = Database_thaotaccsdl.AppCode.Database.SanPham.Thongtin_SanPham_By_MaMau_TatCa(ma);
            if (dt1.Rows.Count > 0)
            {
                ...
                if (kiemtra == 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        ...
                        Database_thaotaccsdl.AppCode.Database.Mau.Mau_Delete(ma);
                        Response.Write(1);
                }
                else
                    Response.Write(2);
