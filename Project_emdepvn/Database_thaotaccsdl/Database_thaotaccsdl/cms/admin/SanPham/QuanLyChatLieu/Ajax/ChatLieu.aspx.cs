...
namespace Database_thaotaccsdl.cms.admin.SanPham.QuanLyChatLieu.Ajax
{
    public partial class ChatLieu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (action)
            {
                case "XoaChatLieu": XoaChatLieu(ma); break;
            }
        ...
        private void XoaSanPham(string ma)
        {
            ...
            dt1 = Database_thaotaccsdl.AppCode.Database.SanPham.Thongtin_SanPham_By_MaChatLieu_TatCa(ma);
            if (dt1.Rows.Count > 0)
            {
                ...
                if (kiemtra == 0)
                {
                    for (int i = 0; i < dt1.Rows.Count; i++)
                    {
                        ...
                        Database_thaotaccsdl.AppCode.Database.ChatLieu.ChatLieu_Delete(ma);
                        Response.Write(1);
                }
                else
                    Response.Write(2);
        ...
        private void XoaChatLieu(string ma)
        {
            DataTable dt1 = new DataTable();
            dt1 = Database_thaotaccsdl.AppCode.Database.SanPham.Thongtin_SanPham_By_MaChatLieu_TatCa(ma);
            if (dt1.Rows.Count == 0)
