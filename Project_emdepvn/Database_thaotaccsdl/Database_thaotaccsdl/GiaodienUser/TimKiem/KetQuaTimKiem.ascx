<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KetQuaTimKiem.ascx.cs" Inherits="Database_thaotaccsdl.GiaodienUser.TimKiem.KetQuaTimKiem" %>
...
<div class="hangMoiVeHotNhat">
    ...
    <asp:Literal ID="ltrKQSearchByAll" runat="server">
