<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SanPhamHienThiDanhSach.ascx.cs" Inherits="Database_thaotaccsdl.GiaodienUser.SanPham.SanPhamHienThiDanhSach" %>
...
<div class="hangMoiVeHotNhat">
    <div class="baongoai">    <link href="../../cms/admin/css/Default.css" rel="stylesheet" />
    <asp:Literal ID="ltrDanhSachSanPhamTheoMaDM" runat="server">
