<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachTinTuc.ascx.cs" Inherits="Database_thaotaccsdl.GiaodienUser.TinTuc.DanhSachTinTuc" %>
...
<div class="hangMoiVeHotNhat">
    ...
    <asp:Literal ID="ltrDanhSachTinTucTheoMaDM" runat="server">
