...
public partial class onepay_vpc_dr : System.Web.UI.Page
{
    ...
    {
        string SECURE_SECRET =  Database_thaotaccsdl.AppCode.Onepay.OnepayNoiDiaCode.SECURE_SECRET;//Bích: cần thay bằng mã thật từ app_code
        ...
        //string mathanhtoantructuyen = merchTxnRef;
        //if (mathanhtoantructuyen.Length > 10) { mathanhtoantructuyen10kitu = mathanhtoantructuyen.Substring(0, 10); }
        //else
        //    mathanhtoantructuyen10kitu = mathanhtoantructuyen;
        ...
        if (hashvalidateResult == "CORRECTED" && txnResponseCode.Trim() == "0")
        {
            ...
            Response.Write("<div class='result'>Đã thanh toán thành công "+mathanhtoantructuyen+@"</div>");
        }
        ...
        else
        {
            ...
            Response.Write("Error description : " + message + "<br/>");
            Response.Write("<div class='result'>Emdep.vn: Sorry! Thanh toán không thành công</div>");
        }
    }
}